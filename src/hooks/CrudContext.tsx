...
export interface CrudContextProps<T> {
  ...
  export const CrudContext = createContext<CrudContextProps<any>>(defaultContextValue);


  export const CrudContextProvider = <T extends object>({ children }: { children: ReactNode }) => {
    ...
    const state: CrudContextProps<T> = {
        openAddModal,
        setOpenAddModal,
        openEditModal,
        setOpenEditModal,
